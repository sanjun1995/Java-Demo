package com.sanjun.project.quartz3.utils;
...
/**
 * Created by caozhixin on 2019-11-06 14:41
 */
public class QuartzUtils {
     ...
     * @throws Exception
     */
    public static void createScheduledJob(Scheduler scheduler, QuartzBean quartzBean) {
        try {
     ...
     */
    public static void pauseScheduledJob(Scheduler scheduler, String jobName) {
     ...
     * @throws SchedulerException
     */
    public static void updateScheduledJob(Scheduler scheduler, QuartzBean quartzBean) {
        try {
            // 获取到对应任务的触发器
     ...
     * @throws SchedulerException
     */
    public static void deleteScheduledJob(Scheduler scheduler, String jobName) {
        JobKey jobKey = JobKey.jobKey(jobName);
        try {
